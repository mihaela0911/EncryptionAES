...
const int reversedSBox[][KEY_SIZE] =
{
...
void printChar(int messageMatrix[][MATRIX_SIZE])
{
	for (size_t row = 0; row < MATRIX_SIZE; row++)
	{
		for (size_t col = 0; col < MATRIX_SIZE; col++)
...
void addRoundKey(int messageMatrix[][MATRIX_SIZE], int keyMatrix[][MATRIX_SIZE])
{
	...
	for (size_t row = 0; row < MATRIX_SIZE; row++)
	{
		for (size_t col = 0; col < MATRIX_SIZE; col++)
		{
			/*std::cout << "xor" << (messageMatrix[row][col] ^ keyMatrix[row][col]) << std::endl;
			std::cout << "key" << keyMatrix[row][col] << std::endl;
			std::cout << "matrix" << messageMatrix[row][col] << std::endl;*/
			messageMatrix[row][col] = (messageMatrix[row][col] ^ keyMatrix[row][col]);
			//std::cout << "newm" << messageMatrix[row][col] << std::endl;
		}
		/*print(messageMatrix);
		std::cout << std::endl;*/
	}
